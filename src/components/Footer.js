...
const Footer = () => {
	return (
		<div className='font-roboto rounded-div mt-8 pt-8 text-primary'>
				...
				<div className='text-right'>
					<div className='w-full flex justify-end'>
						<div className='w-full md:w-[300px] py-4 relative'>
							<div className='flex justify-center md:justify-end py-4 md:py-4 mt-[-1rem]'>
								<ThemeToggle />
							</div>
							...
							<div className='py-4'>
								<form>
									<input
										className='bg-primary border border-input p-2 mr-2 w-full shadow-xl rounded-xl md:w-auto'
										type='email'
